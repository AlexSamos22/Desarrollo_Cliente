...
class mamiPez extends Animal{
    constructor(nombre, edad, formaDeMoverse, hábitat, peso, numeroDeAletas, tieneCola){
        super('mamiPez', nombre, edad, formaDeMoverse, hábitat, peso);
        this.numeroDeAletas = numeroDeAletas;
        this.tieneCola = tieneCola;
    }
}
let miMixin = (mamífero) => class extends mamífero{
}

let miMixin2 = (pez) => class extends pez{
}

class Mamipez extends miMixin(miMixin2(Mamifero)){
}
